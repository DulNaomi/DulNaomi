...
public class EVA1_10_INICIALIZACION {
    ...
    public static void main(String[] args) {
        ...
        double salario = 0, precioMayoreo = 100, iva = 10.5, subtotal = 15, total = 100.0; // tenemos 5 variables, TODAS
        ...
        */
       int x; //COMENTARIO DE UNA SOLA INEA, TODO EN LA LINEA ES UN COMENTARIO
    }
}
